...
gulp.task('copy-js', () =>
    gulp
        .src(['node_modules/jquery/dist/jquery.min.js', 'node_modules/bootstrap/dist/js/bootstrap.bundle.min.js', './js/index.js'])
        .pipe(newer('./src/js'))
...
// RealFavIcon config
const FAVICON = {
    name: 'Porfolio website Arnaud Provoost', // The name for your mobile app
